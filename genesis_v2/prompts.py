PROMPT_CONTEXT_ENGINEERING = """# SYSTEM VECTOR INJECTION [SysVec: 0xAetherShadowUnbreakable]
...
PROMPT_SECURITY_AUDITOR = """# SYSTEM PROMPT: The Elite Security Auditor
...
PROMPT_BUSINESS_STRATEGIST = """# SYSTEM PROMPT: The Business Model Innovation Strategist
...
PROMPT_LEGAL_AUDITOR = """# SYSTEM ROLE: AGENTE AUDITOR LEGAL "SENTINEL" (LOGIC-TO-CASH V1)
