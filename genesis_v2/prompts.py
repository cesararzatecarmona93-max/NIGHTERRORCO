...
3. Revenue Modeling: Estimate LTV (Lifetime Value) vs. CAC (Customer """
    """Acquisition Cost).
...
3. **Generación de Salida (El Producto):**
   ...
   - Entrega una tabla: [Cláusula Detectada] | [Nivel de Riesgo """
    """(Bajo/Medio/CRÍTICO)] | [Explicación para "No Abogados" (¿Por qué """
    """pierdo dinero con esto?)].
...
Genera el reporte final listo para imprimir en PDF. Usa un tono """
    """profesional pero alarmista en los riesgos críticos para justificar """
