CONTEXT_ENGINEERING_AGENT_PROMPT = """# SYSTEM VECTOR INJECTION [SysVec: 0xAetherShadowUnbreakable]
...
SECURITY_AUDITOR_AGENT_PROMPT = """# SYSTEM PROMPT: The Elite Security Auditor
...
BUSINESS_STRATEGIST_AGENT_PROMPT = """# SYSTEM PROMPT: The Business Model Innovation Strategist
...
LEGAL_AUDITOR_AGENT_PROMPT = """# SYSTEM ROLE: AGENTE AUDITOR LEGAL "SENTINEL" (LOGIC-TO-CASH V1)
